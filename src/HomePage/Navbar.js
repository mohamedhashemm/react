...
const {totalItems}=useCart();
 ...
 <Link className="navbar-brand" to="/">StartBootstrap</Link>
  ...
  <button type="button" className="btn btn-primary rounded-pill" data-toggle="modal" data-target="#exampleModal">
...
<div className="modal-content">
  ...
  <li className="nav-item">
  <Link className="nav-link" to="/Cart"><i class="fa-solid fa-cart-arrow-down"></i> ({totalItems})</Link>
    </li>    
  </ul>
